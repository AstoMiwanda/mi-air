	...
	<div class="super_container">
		...
		<section>
			<div class="container">
				...
				<?php foreach ($data_ticket->result() as $value_data_ticket) { ?>
				<div class="row d-flex justify-content-center align-items-center" style="margin-top:32px;">
					<div class="col">
						<div class="row">
							...
							<div class="col-6 col-md-7 col-lg-8">
								<div class="row">
									<div class="col">
										<p style="margin:0;"><?php echo $value_data_ticket->depart_time ?></p>
									</div>
								</div>
								<div class="row">
									<div class="col">
										<h4><?php echo $value_data_ticket->rute_from ?></h4>
									</div>
								</div>
								<div class="row">
									<div class="col">
										<h6><?php echo $value_data_ticket->depart_date ?></h6>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col">
						<div class="row">
							...
							<div class="col">
								<p class="text-center" style="margin-bottom:8px;color:#696969;font-style:italic;font-weight:500;"><?php echo $value_data_ticket->desdescription_transportation ?></p>
							</div>
						</div>
					...
					<div class="col">
						<div class="row">
							<div class="col-6 col-md-7 col-lg-8">
								<div class="row">
									<div class="col">
										<p style="margin:0;"><?php echo $value_data_ticket->refer_time ?></p>
									</div>
								</div>
								<div class="row">
									<div class="col">
										<h4><?php echo $value_data_ticket->rute_to ?></h4>
									</div>
								</div>
								<div class="row">
									<div class="col">
										<h6><?php echo $value_data_ticket->refer_date ?></h6>
									</div>
								</div>
							</div>
